...
Only precondion is installed grunt-cli. That can be done with the following command:
...
To build the Javascript file out of the Typescript just call and generate the packed grunt-msbuild.tar file that holds all the needed
package content just call:
...
* the TypeScript source in src/ will be linted
* compiled with tsc into directory tasks
* the result packed into grunt-msbuild.tar file

## Release Notes

|Version| Notes|
|-------|------|
|2.0|<ul><li>switched to TypeScript</li><li>adopted code according to that</li><li>switched from vswhere 2.6.4 to 2.8.4</li><li>added new options: inferBuildPathProducts, inferBuildPathRequires, InferBuildPathVersion</li><li>fixed issue that prevents correct detection of vs dir with vswhere</li><li>completed ReadMe</li><li>added Grunt file and build steps</li></ul>
